...
class MappingEntityMapperTest {
    ...
    @InjectMocks lateinit var mappingEntityMapper: MappingEntityMapper
    ...
    fun shouldMapMappingEntityToExistingMapping() {
        ...
        assertThat(
            mappingEntityMapper.toExistingMapping(
    ...
    fun shouldMapNewMappingToMappingEntityWithId() {
        ...
        assertThat(
            mappingEntityMapper.toMappingEntity(ID, MappingTestData.createNewMapping()),
        )
            .isEqualTo(MappingTestData.createMappingEntity())
    }
}
