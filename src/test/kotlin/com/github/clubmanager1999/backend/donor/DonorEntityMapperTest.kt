...
class DonorEntityMapperTest {
    @InjectMocks lateinit var donorEntityMapper: DonorEntityMapper

    @Test
    fun shouldMapDonorEntityToExistingDonor() {
        assertThat(
            donorEntityMapper.toExistingDonor(
    ...
    fun shouldMapNewDonorToDonorEntityWithId() {
        assertThat(
            donorEntityMapper.toDonorEntity(ID, DonorTestData.createNewDonor()),
        )
